...
function ccb_settings_api(){
    ...
    add_settings_section(
        'ccb_options_section',
        __('Clearblocks Settings', 'cc-clearblocks'),
    ...
    add_settings_field(
        'og_title_input',
        __('Open Graph Title', 'cc-clearblocks'),
        'og_title_input_cb',
        'clearblocks-options-page',
        'ccb_options_section'
    );
    add_settings_field(
        'og_image_input',
        __('Open Graph Image', 'cc-clearblocks'),
        'og_image_input_cb',
        'clearblocks-options-page',
        'ccb_options_section'
    );
    add_settings_field(
        ...
        __('Open Graph Description', 'cc-clearblocks'),
    ...
    add_settings_field(
        'og_enable_input',
        __('Open Graph Enable', 'cc-clearblocks'),
        'og_enable_input_cb',
        'clearblocks-options-page',
        'ccb_options_section'
    );
...
function og_image_input_cb(){
    $options = get_option('clearblocks_options');
    ?>
    <input type="hidden" name="clearblocks_options[og_img]" id="up_og_image"
  ...
  function og_description_input_cb(){
    ...
    ?>
    <textarea 
      name="clearblocks_options[og_description]"
      class="large-text"
  ...
  function og_enable_input_cb(){
    ...
    <label for="up_enable_og"> 
      <input name="clearblocks_options[enable_og]" type="checkbox" id="up_enable_og" 
